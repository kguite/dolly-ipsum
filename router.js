...
import { loremIpsum} from "./src/generator.js";
...
router.get('/', (request, response) => {
  ...
  let fileContents = readFileSync("./public/index.html", {encoding: "utf8"});
...
router.post('/', (request, response) => {
  request.on("data", function(inputValue) {
    ...
    // in a variable
    let numberOfParagraphs = parse(query).numberOfParagraphs;
